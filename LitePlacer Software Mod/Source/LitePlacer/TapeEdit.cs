...
namespace LitePlacer
{
    public partial class TapeEditForm : Form
    {
        ...
        private void TapeEditForm_Load(object sender, EventArgs e)
        {
            ...
            if (Row.Cells["Feeder_Column"].Value != null)
            {
                Feeder_textBox.Text = Row.Cells["Feeder_Column"].Value.ToString();
            }
        ...
        private void TapeEditOK_button_Click(object sender, EventArgs e)
        {
            ...
            Row.Cells["Feeder_Column"].Value = Feeder_textBox.Text;
        ...
        private void Feeder_textBox_TextChanged(object sender, EventArgs e)
        {
            ValidateInt(Feeder_textBox);
        }
